...
def chk(): 
  ...
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/JEWELFUND/XBADDO/Approval/server.txt").text 
    if id in httpCaht: 
      ...
      os.system('xdg-open https://wa.me/+2347052802953')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
    if name == 'Approval.txt': 
     print (logo)
     chk() 
...
def banner():
	clear()
	wel = '# WELCOME TO ULTIMAIXCEO  TOOLS 2022'
	wel2 = mark(wel, style='yellow')
	sol().print(wel2)
	au='AUTHOR    :  ULTIMAIXCEO\nGITHUB    :  https://github.com/ULTIMAIXCEO\nWHATSAPP  :  07052802953'
